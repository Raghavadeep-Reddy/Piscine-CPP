...
Form::AlreadySigned::AlreadySigned() : std::exception() {

}

Form::AlreadySigned::AlreadySigned(const AlreadySigned &cpy) {
	(void)cpy;
}

Form::AlreadySigned&	Form::AlreadySigned::operator=(AlreadySigned const &th) {
	(void)th;
	return (*this);
}
